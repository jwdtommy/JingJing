...
import com.jwd.photo123.BuildConfig;
...
public final class MLog {
	...
	/* log的tag */
	public static final String TAG = "jwd";
	/* 是否用AlertDialog输出log */
	...
	// public static void httpPost(String pre, String url, Map<String, String>
	// map) {
	// String log = url + "?";
	...
	// public static String urlPost2Get2(String url, Map<String, String> map) {
	// String getUrl = url + "&";
	// Set<String> set = map.keySet();
	// Iterator<String> iterator = set.iterator();
	// while (iterator.hasNext()) {
